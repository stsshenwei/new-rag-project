...
- Affected backend services: `backend/app/services/agent_runtime.py`, `backend/app/services/agent_runtime_tools.py`, `backend/app/models/agent_runtime.py`, and related runtime policy/config wiring in `backend/app/main.py`.
